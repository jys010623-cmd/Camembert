...
export class SpriteLoader {
  ...
  /**
   * Drop a single clip's cached frames so its (large) decoded images can be
   * garbage-collected. Used while measuring the global bounding box one clip at
   * a time to keep peak memory bounded; the clip reloads lazily when next played.
   */
